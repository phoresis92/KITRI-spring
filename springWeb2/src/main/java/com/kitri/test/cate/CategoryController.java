...
/*	@ModelAttribute("LargeTypeList")
	...
	@RequestMapping("/cate/getName")
	public ModelAndView getName(@RequestParam(value="num") int num) {
		
		GetName names = cService.getName(num);
		
		ModelAndView mav = new ModelAndView("cate/getName");
